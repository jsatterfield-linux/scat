...
using
$$\text{{\tt ./src/SCAT3 <genotype filename> <location filename> <outputdir> L}}$$ where {\tt L} is the number of loci in the genotype file.
...
$$ \text{mkdir results}\\
\text{{\tt ./src/SCAT3 tests/test.genotype.txt tests/test.location.txt results 2}}$$ 
(make sure that {\tt SCAT3} is in the current directory.)  Here 2 indicates that there are 2
